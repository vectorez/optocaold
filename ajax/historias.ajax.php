	...
	*/
	class AjaxHistorias
	{
		...
		public function ajaxGetHistorias(){
			$campos = "historias_id_i as id, CONCAT(pacientes_nombres_v,' ',pacientes_apellidos_v) as nombre, pacientes_documento_v, pacientes_telefono_v, TIMESTAMPDIFF(YEAR,pacientes_fecha_nacimiento_d,CURDATE()) as fecha_nacimiento, DATE_FORMAT(historias_fecha_d, '%Y-%m-%d') as fecha, historias_numero_v, usuarios_nombres_v, historias_id_i";
