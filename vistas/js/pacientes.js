...
//'&nbsp;<button class="btn btn-info btnHistorialPaciente" title="Ver el historico del Paciente" id_Paciente data-toggle="modal" data-target="#modalHistoricoPaciente"><i class="fa fa-search"></i></button>'
